...
1. What is the DOM?
Dom is a object-oriented representation of the webpage
2. What is an event?
an Event is a method that happen in the system we are programing
3. What is an event listener?
event listener is a method attaches to a specified element to handle a special event
4. Why would we convert a NodeList into an Array?
NodeList doens't have all the method that we can use with an Array

5. What is a component?
component are indepen and reusable bits of code
